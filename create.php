...
<body>
    <div class="form-container">
        <form method="post" action="formhandler.php">
            ...
            <input type="text" id="course_id" name="course_id" pattern="COSC\d{4}" required
                title="Course ID must start with COSC followed by 4 digits">
            <label for="title">Title:</label>
            <input type="text" id="title" name="title" pattern="[A-Z][A-Za-z0-9 ]*" required
            ...
            <input type="number" id="credit_points" name="credit_points" min="1" max="12" step="1" required
